          ...
          @else
            ...
            <div class="relative w-full h-full flex items-center justify-center">
              ...
              <div class="relative z-10 text-center p-6">
                ...
                <p class="text-sm font-semibold text-blue-700">Riau Pos - Honda SBL</p>
      ...
      <div class="border-t lg:border-t-0 lg:border-l border-gray-100">
        <div class="p-6 md:p-8">
          ...
          <div class="mb-8">
            ...
            <p class="text-sm text-gray-500 mb-4">Latest updates from SBL</p>
                        ...
                        @else
                          <div class="w-full h-full flex items-center justify-center bg-gradient-to-br from-blue-200 to-blue-100">
                            <div class="text-center p-4">
                              ...
                              <p class="text-xs font-semibold text-blue-900">Riau Pos SBL</p>
                            </div>
                          </div>
                        @endif
