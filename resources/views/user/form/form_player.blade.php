        ...
        <div class="form-container">
            ...
            <div class="form-header">
                <div class="d-flex align-items-center">
                    <a href="{{ route('form.team.success', ['team_id' => $team->team_id]) }}" class="text-white me-3">
                ...
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-0">
                            ...
                            <strong>Bukti pembayaran wajib diupload</strong> dan biaya hanya dibayar sekali oleh Leader.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-0">
                            ...
                            <strong>Tidak perlu membayar</strong> - biaya sudah dibayar oleh Leader.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4 p-md-5">
                <form id="playerForm" action="{{ route('form.player.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="step-content" id="step-3">
                        <h4 class="mb-4 text-primary">
                            <i class="fas fa-running me-2"></i>Data Fisik & Basket
                        </h4>
                        ...
                        <div class="row">
                            ...
                            <!-- Basketball Position (for basketball players only) -->
                            @if($category !== 'dancer')
                            <div class="col-md-6 mb-3">
                                <label for="basketball_position" class="form-label">
                                    Posisi Basket
                                    <i class="fas fa-basketball-ball ms-1 text-orange"></i>
                                </label>
                                <select class="form-select @error('basketball_position') is-invalid @enderror" 
                            ...
                            <div class="col-md-3 mb-3">
                                <label for="jersey_number" class="form-label">
                                    Nomor Jersey
                                    <i class="fas fa-hashtag ms-1 text-muted"></i>
                                </label>
                                <input type="number" 
                    ...
                    <div class="step-content" id="step-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <!-- Payment Proof (For Leader Only) -->
                                @if($role === 'Leader')
                                <div class="mb-3 border-top pt-3">
                                    <h6 class="text-warning">
                                        <i class="fas fa-money-bill-wave me-2"></i>Bukti Pembayaran
                                    </h6>
                                    ...
                                    <div class="form-text">
                                        ...
                                        <small class="text-warning">
                                            ...
                                            Hanya Leader yang perlu upload bukti pembayaran
                                        </small>
                                    </div>
                                    @error('payment_proof')
                                        <div class="invalid-feedback">{{ $message }}</div>
