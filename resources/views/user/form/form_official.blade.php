                        ...
                        <div class="mb-5">
                            ...
                            <div class="info-box" style="background-color: #cff4fc; border: 1px solid #b6effb; border-radius: 12px; padding: 1rem; margin-bottom: 1.5rem; color: #055160;">
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p style="margin-bottom: 0; font-size: 0.9rem;">Format: JPG, JPEG, PNG, PDF (maks 2MB). Pastikan dokumen terbaca jelas.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <small class="text-muted">Lisensi kepelatihan</small>
                                </div>
                                <!-- 🔥 TAMBAHKAN INPUT SURAT TUGAS DI SINI 🔥 -->
                                <div class="col-md-3">
                                    <label class="form-label fw-medium">Surat Tugas <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control @error('assignment_letter') is-invalid @enderror"
                                        id="assignment_letter" name="assignment_letter" accept="image/jpeg,image/png,image/jpg,application/pdf" required>
                                    <small class="text-muted">Surat tugas dari sekolah</small>
                                </div>
                            </div>
                        </div>
