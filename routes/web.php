...
Route::prefix('form')->name('form.')->group(function () {
    ...
    // Check school logo (untuk validasi logo existing school)
    Route::post('/team/check-school-logo', [FormTeamController::class, 'checkSchoolLogo'])->name('team.checkSchoolLogo');
    // ================= PLAYER REGISTRATION =================
